...
public class TowerDefenseGameRev {

    public final static int ROWS = 3;
    public final static int COLUMNS = 10;
    public final static int INITIAL_HEALTH = 6;
    public final static int ENEMY_WAVES = 5;
    public final static int MAX_ENEMY_SPAWN_RATE = 6;
    public final static double SHOCKWAVE_SPAWN_RATE = 1;
    ...
    public final static String SHOCKWAVE_SYMBOL = "\uD83C\uDF00";

    private static GameManagerRev gameManager;
    ...
    private static void initializeVariables() {
        ...
        gameManager = new GameManagerRev();
    }
    ...
    private static void handleGameEnding() {
        ...
        TowerRev tower = gameManager.getTower();
    ...
    private static void renderGameMap() {
        ArrayList<EnemyWaveRev> enemyWaves = gameManager.getEnemyWaves();
