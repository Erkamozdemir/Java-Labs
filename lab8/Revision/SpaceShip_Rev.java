 ...
 */
public class SpaceShip_Rev extends Entity_Rev {
     ...
     */
    public SpaceShip_Rev(int x, int y, int health) {
        super(x, y, GameEngine_Rev.SPACE_SHIP_SYMBOL);
        this.health = health;
    }
     ...
     */
    public Bullet_Rev shoot() {
        return new Bullet_Rev(x, y);
    }

    public Bullet_Rev shootInfinity() {
        return new InfinityBullet(x, y);
    }
